...
const PostsListPage = () => {
  ...
  return (
    <div className="p-6">
        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden md:block">
            ...
            <input 
              ...
              className="pl-10 pr-4 py-2 bg-white border border-slate-200 focus:border-indigo-300 focus:ring-4 focus:ring-indigo-100 rounded-xl text-sm transition-all w-64"
            />
          </div>
      ...
      <div className="flex items-center gap-2 bg-white p-1.5 rounded-xl border border-slate-200 shadow-sm mb-6 w-fit">
